          ...
          },
          {
            ...
            Inputs: [
              ...
              },
              {
                ...
                value: 1,
                disabled: "never",
                tooltip: "p-parameter, which controls the severity of tag-jump removal. It adjusts the exponent in the UNCROSS formula. Default is 1. Opt for 1/2 or 1/3 to steepen the curve.",
                type: "numeric",
                rules: [(v) => v > 0 || "ERROR: specify values > 0"],
              },
            ],
